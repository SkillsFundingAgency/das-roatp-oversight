...
namespace SFA.DAS.RoatpOversight.Web.Infrastructure.ApiClients
{
    public abstract class RoatpApiClientBase<CB>
    {
        ...
        protected readonly IRoatpRegisterTokenService _tokenService;

        public RoatpApiClientBase(string baseUri, ILogger<CB> logger, IRoatpRegisterTokenService tokenService)
        {
