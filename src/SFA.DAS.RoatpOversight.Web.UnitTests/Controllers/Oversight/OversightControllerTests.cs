...
public class OversightControllerTests
{
    ...
    public void SetUp()
    {
        ...
        _controller = new OversightController(_searchTermValidator.Object,
                                              ...
                                              new AppealPostRequestValidator(),
                                              new OutcomePostRequestValidator(),
                                              new ConfirmOutcomePostRequestValidator(),
                                              new ConfirmAppealOutcomePostRequestValidator())
        {
    ...
    public async Task Post_Appeal_redirects_to_confirmation()
    {
        ...
        var command = new AppealPostRequest()
        {
            ...
            UnsuccessfulText = "test",
            InProgressExternalText = "test",
            UnsuccessfulExternalText = "test"
        };
